  ...
  <main>
    ...
    <section class="presentation">
      <div class="desc">
        ...
        <p>
          Après une recherche approfondie de Mr PIATA JACQUES sur les accidents de la route, il a
          constaté que la prise en charge des victimes dans les hôpitaux n'existe pas, les medecins
          demandent toujours les frais avant de commencer les soins. <br />
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-xl-7 col-lg-8 col-md-11 col-sm-11">
            <div class="section-title text-center mb-90">
              <span>Les servives de l'association</span>
              <h2>Nous vous offrons la meilleure prise en charge possible</h2>
            </div>
          </div>
        </div>
        <!-- Section caption -->
        ...
        <div class="row justify-content-center">
          <div class="col-xl-6 col-lg-7 col-md-9 col-sm-10">
            <div class="section-title text-center mb-100">
              ...
              <h2>quelques images de nos descentes</h2>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <div class="testimonial">
      ...
      <div class="testimonial-content">
            ...
            <div class="slider-list">
              <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div>
                      <span role="img" class="anticon star-icon"
                        ><svg
                          width="3em"
                          height="3em"
                          viewBox="0 0 24 24"
                ...
                <div class="buttons">
                  <button
                    ...
                    data-bs-slide="prev"
                  >
                    <span aria-hidden="true" role="img" class="anticon"
                      ><svg
                        width="1em"
                        height="1em"
                        viewBox="0 0 22 16"
        ...
        <img src="@/assets/crash3.jpg" class="testimonial-banner" alt="testimonial banner" />
      </div>
    </div>
...
.gallery-area .gallery-img1 {
  background-image: url(../assets/crash1.jpg);
  height: 400px;
  background-repeat: no-repeat;
...
.gallery-area .gallery-img2 {
  background-image: url(../assets/crash2.jpg);
  height: 500px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.gallery-area .gallery-img3 {
  background-image: url(../assets/crash3.jpg);
  height: 500px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.gallery-area .gallery-img5 {
  background-image: url(../assets/crash5.jpg);
  height: 430px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.gallery-area .gallery-img8 {
  background-image: url(../assets/crash8.jpg);
  height: 490px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.gallery-area .gallery-img9 {
  background-image: url(../assets/crash7.jpg);
  height: 510px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.gallery-area .gallery-img10 {
  background-image: url(../assets/crash6.jpg);
  height: 390px;
  background-repeat: no-repeat;
  background-position: top center;
  background-position: center;
...
.quote-up {
  ...
  padding: 11px;
  box-shadow:
    rgba(12, 26, 75, 0.1) 0px 0px 1px,
    rgba(20, 37, 63, 0.06) 0px 10px 16px;
  border-radius: 12px;
  background-color: #fff;
  z-index: 3;
}
