  ...
  <main>
    <nav>
      ...
      <ul>
        ...
        <li><RouterLink to="/portfolio">Dossiers</RouterLink></li>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-11">
                <div class="single-footer-caption mb-50">
                  ...
                  <div class="myform">
                    <div>
                      <form>
                        <input type="email" name="EMAIL" placeholder="Entrez le montant" />
                        <div class="form-icon">
    ...
    <div id="back-top" @click="scrollToTop">
      <a title="Go to Top" href="#">
        <i class="fa-regular fa-hand-pointer" style="color: #ffffff"></i
      ></a>
    </div>
  </main>
</template>
